          ...
          <div className="relative order-2 min-w-0 basis-full sm:order-none sm:basis-auto sm:flex-1 sm:min-w-[160px] sm:max-w-sm">
            ...
            {showSearchSuggestions && (
              <div
                ...
                role="listbox"
                className="absolute left-0 right-0 top-[calc(100%+6px)] z-40 overflow-hidden rounded-xl border border-white/[0.08] bg-[#090907]/[0.98] shadow-[0_18px_60px_rgba(0,0,0,0.55)] backdrop-blur-xl"
              >
